...
#to glance at the structure of data set
str(creditcard)

creditcard$Class <- factor(creditcard$Class,levels=c(0,1))
 # to convert Class that was int into factor
...
#to get the distribution of fraud and legit transactions in the dataset
table(creditcard$Class)

#get percebtage of fraud and legit transactions in the dataset
prop.table(table(creditcard$Class))

#pie chart for credit card transactions
...
#creating training and test cases for fraud detection model
...
#calculate the value of dup_size parameter of SMOTE function
...
#decision tress without using smote data
